...
user in an INI file next to HaxeStudioPortable.exe called HaxeStudioPortable.ini.
...
copy AppNamePortable.ini from this directory to HaxeStudioPortable.ini next to
HaxeStudioPortable.exe. The options in the INI file are as follows:
